import * as THREE from '/static/assets/js/three.module.js';

import { zipSync, strToU8 } from '/static/assets/js/jsm/libs/fflate.module.js';
...
function MenubarFile( editor ) {
	...
	option.onClick( async function () {
		...
		var { ColladaExporter } = await import( '/static/assets/js/jsm/exporters/ColladaExporter.js' );
	...
	option.onClick( async function () {
		...
		var { DRACOExporter } = await import( '/static/assets/js/jsm/exporters/DRACOExporter.js' );
	...
	option.onClick( async function () {
		...
		var { GLTFExporter } = await import( '/static/assets/js/jsm/exporters/GLTFExporter.js' );
	...
	option.onClick( async function () {
		...
		var { OBJExporter } = await import( '/static/assets/js/jsm/exporters/OBJExporter.js' );
	...
	option.onClick( async function () {
		...
		var { PLYExporter } = await import( '/static/assets/js/jsm/exporters/PLYExporter.js' );
	...
	option.onClick( async function () {
		...
		var { STLExporter } = await import( '/static/assets/js/jsm/exporters/STLExporter.js' );
	...
	option.onClick( async function () {
		...
		var { USDZExporter } = await import( '/static/assets/js/jsm/exporters/USDZExporter.js' );
	...
	option.onClick( function () {
		...
		loader.load( '/static/assets/js/three.module.js', function ( content ) {

			toZip[ 'js/three.module.js' ] = strToU8( content );

		} );
		loader.load( '/static/assets/js/jsm/webxr/VRButton.js', function ( content ) {
